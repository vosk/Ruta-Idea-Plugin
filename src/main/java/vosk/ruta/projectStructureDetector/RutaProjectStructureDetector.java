package vosk.ruta.projectStructureDetector;
 ...
 */
public class RutaProjectStructureDetector extends ProjectStructureDetector {
  ...
  public DirectoryProcessingResult detectRoots(@NotNull File dir,
    ...
    for (File child : children) {
      if (FileUtilRt.extensionEquals(child.getName(), "st")) {
        File root;
        for (String pattern : new String[]{"script"}) {
