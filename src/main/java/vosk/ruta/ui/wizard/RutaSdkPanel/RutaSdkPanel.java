package vosk.ruta.ui.wizard.RutaSdkPanel;
 ...
 */
public class RutaSdkPanel extends JPanel {
    ...
    myDownloadLink = new ActionLink("Download and Install Redline Smalltalk", new AnAction() {
      ...
      public void actionPerformed(AnActionEvent anActionEvent) {
        ...
        PathChooserDialog pathChooser = FileChooserFactory.getInstance()
            .createPathChooser(descriptor, null, RutaSdkPanel.this);
        pathChooser.choose(VfsUtil.getUserHomeDir(), new FileChooser.FileChooserConsumer() {
          ...
          public void consume(List<VirtualFile> virtualFiles) {
            if (virtualFiles.size() == 1) {
              ...
              AccessToken accessToken = ApplicationManager.getApplication().acquireWriteActionLock(RutaSdkPanel.class);
              try {
              ...
              FileDownloader downloader = fileService.createDownloader(Arrays.asList(fileDescription), null, RutaSdkPanel.this, "redline-deploy.zip");
